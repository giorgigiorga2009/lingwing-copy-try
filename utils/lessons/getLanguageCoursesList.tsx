...
export const getCurrentLanguageCoursesList = async ({
  ...
  const url = `${process.env.defaultURL}/public/getCurrentLanguageCoursesList?lang=${languageTo}&currentCourseId=${languageCourseId}&currentILearnFrom=${languageFrom}&currentLanguageId=${languageId}`
  const payload = {
