...
export const getToken = ({ email, password, repeatPassword }: Auth) => {
  return axios({
    method: 'post',
    url: `${process.env.NEXT_PUBLIC_DEFAULT_URL}/public/auth/signup?lang=eng`,
    // headers: {
    //   ...HEADERS,
    //   Authorization: 'null',
    // },
...
export const auth = ({ email, password, repeatPassword }: Auth) => {
  return getToken({ email, password, repeatPassword })
    .then(response =>
      axios({
        url: `${process.env.NEXT_PUBLIC_DEFAULT_URL}/user/profile?lang=eng`,
        headers: {
          ...HEADERS,
...
export const login = ({ email, password }: Auth) => {
  return (
    axios({
      method: 'post',
      url: `${process.env.NEXT_PUBLIC_DEFAULT_URL}/public/auth/login?lang=eng`,
      // headers: {
      //   ...HEADERS,
      //   Authorization: 'null',
      // },
...
export const getUserProfileData = (token: string) => {
  return axios({
    url: `${process.env.NEXT_PUBLIC_DEFAULT_URL}/user/profile`,
    headers: {
      ...HEADERS,
      Authorization: token,
    },
...
export const resetPassword = ({
  ...
  return axios({
    method: 'post',
    url: `${process.env.NEXT_PUBLIC_DEFAULT_URL}/public/auth/reset`,
    headers: {
      ...HEADERS,
      Authorization: token || '',
    },
...
export const forgotPassword = (email: string) => {
  return axios({
    method: 'post',
    url: `${process.env.NEXT_PUBLIC_DEFAULT_URL}/public/auth/forgot`,
    // headers: {
    //   ...HEADERS,
    // },
    data: {
