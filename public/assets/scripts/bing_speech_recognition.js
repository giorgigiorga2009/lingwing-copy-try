  ...
  (function (ProjectOxford) {
    (function (SpeechRecognition) {
      (function (SpeechRecognitionMode) {
        ...
        SpeechRecognition.SpeechRecognitionMode ||
          (SpeechRecognition.SpeechRecognitionMode = {})
      );
      ...
      var MicrophoneRecognitionClient = (function () {
        ...
        MicrophoneRecognitionClient.prototype.startMicAndRecognition =
          function () {
            var _this = this;
            this._sr.onresult = function (e) {
              if (e.results[e.resultIndex].final) {
                ...
                _this.onPartialResponseReceived(
                  e.results[e.resultIndex][0].transcript
                );
              }
            };
        ...
        MicrophoneRecognitionClient.prototype.endMicAndRecognition =
          function () {
            this._sr.stop();
          };
        return MicrophoneRecognitionClient;
      })();
      SpeechRecognition.MicrophoneRecognitionClient =
      ...
      var DataRecognitionClient = (function () {
        ...
        DataRecognitionClient.prototype.sendAudio = function (
          buffer,
      ...
      (function (SpeechRecognitionServiceFactory) {
        function createDataClient(
          ...
          return new SpeechRecognition.DataRecognitionClient(
            createPrefs(
              speechRecognitionMode,
              language,
              primaryKey,
        ...
        function createDataClientWithIntent(
          language,
          primaryKey,
          secondaryKey,
          luisAppId,
          ...
          var prefs = createPrefs(
            SpeechRecognition.SpeechRecognitionMode.shortPhrase,
            language,
            primaryKey,
            secondaryKey
          );
        ...
        function createMicrophoneClient(
          ...
          return new SpeechRecognition.MicrophoneRecognitionClient(
            createPrefs(
              speechRecognitionMode,
              language,
              primaryKey,
        ...
        function createMicrophoneClientWithIntent(
          language,
          primaryKey,
          secondaryKey,
          luisAppId,
        ...
        SpeechRecognitionServiceFactory.BaseSpeechUrl =
        ...
        SpeechRecognition.SpeechRecognitionServiceFactory ||
          (SpeechRecognition.SpeechRecognitionServiceFactory = {})
      );
      var SpeechRecognitionServiceFactory =
        SpeechRecognition.SpeechRecognitionServiceFactory;
    })(
...
(function (Bing) {
  ...
  var Synthesis = (function () {
    function Synthesis() {
      ...
      request.open(
        "GET",
        "https://speech.platform.bing.com/synthesize/list/voices",
        true
      );
  ...
  var msSpeechSynthesisUtterance = (function () {
    ...
    msSpeechSynthesisUtterance.prototype.removeEventListener = function (
      type,
      listener,
      useCapture
    ) {};
    msSpeechSynthesisUtterance.prototype.addEventListener = function (
      type,
      listener,
      useCapture
    ) {};
  ...
  var Speech = (function () {
    ...
    Speech.prototype.removeEventListener = function (
      type,
      listener,
      useCapture
    ) {};
    Speech.prototype.addEventListener = function (
      type,
      listener,
      useCapture
    ) {};
    ...
    Object.defineProperty(Speech.prototype, "currentSource", {
      set: function (source) {
        ...
        Platform.getCU().done(function (cu) {
          ...
          _this._currentDestination = _this.createRecogitionDestination(
            _this._currentSource,
            cu,
            null
          );
        });
    ...
    Speech.prototype.createRecogitionDestination = function (
      source,
      cu,
      onaudioprocess
    ) {
    ...
    Object.defineProperty(Speech.prototype, "isMicSource", {
      get: function () {
        return (
          null === this.mediaSource || typeof this.mediaSource == "undefined"
        );
      },
      enumerable: true,
      configurable: true,
  ...
  var StringAudioBuffer = (function () {
    ...
    StringAudioBuffer.prototype.getChannelData = function (channel) {
      ...
      for (i = 0; i < data.length; ++i) {
        byteStr = Math.floor((data[i] + 1.0) * 0x7fff)
          .toString(16)
          .replace("-", "");
    ...
    StringAudioBuffer.prototype.copyFromChannel = function (
      destination,
      channelNumber,
      startInChannel
    ) {
      this._audioBuffer.copyFromChannel(
        destination,
        channelNumber,
        startInChannel
      );
    };
    StringAudioBuffer.prototype.copyToChannel = function (
      source,
      channelNumber,
      startInChannel
    ) {
  ...
  (function (Platform) {
    ...
    function supportsNPAPI() {
      if (
        !isEdge() &&
        (navigator.userAgent.indexOf("Firefox") != -1 || isSafari())
      ) {
        return true;
      } else {
        return false;
  ...
  var OxfordAuthenticator = (function () {
    ...
    OxfordAuthenticator.prototype.authenticate = function (
      primaryKey,
      secondaryKey
    ) {
      var _this = this;
      ...
      if (
        !this._response ||
        !this._expireTime ||
        Date.now() >= this._expireTime.getTime()
      ) {
        ...
        xhr.onload = function () {
          if (xhr.readyState == 4) {
            if (xhr.status === 200) {
              ...
              _this._expireTime = new Date(
                Date.now() + parseInt(_this._response.expires_in) * 1000
              );
  ...
  var AdmAuthenticator = (function () {
    ...
    AdmAuthenticator.prototype.authenticate = function (
      primaryKey,
      secondaryKey
    ) {
      var task = new Task();
  ...
  var Riff = (function () {
    function Riff(sampleRate, bitsPerSample) {
      ...
      this.appendUINT32(
        this._sampleRate * (this._bitsPerSample >> 3) * this._channels
      );
  ...
  var LuisClient = (function () {
    ...
    LuisClient.kServiceUrl =
      "https://api.projectoxford.ai/luis/v1/application?subscription-key=";
  ...
  var HttpClient = (function () {
    ...
    HttpClient.prototype.ttsStop = function () {
      ...
      if (src && this.context.state != "suspended") {
        try {
          ...
          writeline(
            "ttsStop: buffer source failed to stop. state: " +
              this.context.state +
              " exception:" +
              e
          );
    ...
    HttpClient.prototype.send = function () {
      ...
      this.getToken().done(function (token) {
        ...
        var serviceUrl = _this.preferences.serviceUri
          .replace("/ws/speech", "")
          .replace("websockets.", "speech.");
        ...
        request.setRequestHeader(
          "Content-Type",
          'audio/wav; codec="audio/pcm"; samplerate=' + _this.sampleRate
        );
        request.setRequestHeader("Authorization", token);
        token = token;
        request.onload = function () {
          if (
            request.response.header.properties.NOSPEECH == "1" &&
            request.response.header.status == "error"
          ) {
            console.log("user isn't speeching");
          }
    ...
    HttpClient.prototype.appendAsUInt8 = function (a) {
      ...
      for (var i = 0; i < a.length; i += incrementBy) {
        this.buffer[this.offset++] = Math.floor((a[Math.floor(i)] - 0.5) * 128);
      }
    };
  ...
  var NaclClient = (function () {
    function NaclClient() {
      ...
      if (devMode() === true) {
        ...
        naclContainer.addEventListener(
          "load",
          function (arg) {
            var i;
    ...
    NaclClient.prototype.removeEventListener = function (
      type,
      listener,
      useCapture
    ) {};
    NaclClient.prototype.addEventListener = function (
      type,
      listener,
      useCapture
    ) {
    ...
    NaclClient.prototype.connect = function (destination, output, input) {
      this.postMessage(["connect", destination.context.sampleRate]);
    };
    ...
    Object.defineProperty(NaclClient.prototype, "preferences", {
      ...
      set: function (prefs) {
        this._preferences = prefs;
        this.postMessage(["setPreferences", prefs]);
      },
      enumerable: true,
      configurable: true,
    });
    ...
    NaclClient.prototype.audioprocess = function (buffer) {
      this.postMessage(["audioprocess", buffer.getChannelData(0), buffer]);
    };
    NaclClient.prototype.tts = function (text, contentType, outputFormat) {
      this.postMessage(["tts", text, contentType, outputFormat]);
      if (this.onttsstart) {
        this.onttsstart();
      }
    };
    NaclClient.prototype.ttsStop = function () {
      this.postMessage(["ttsstop"]);
    };
    return NaclClient;
  })();
  ...
  function shouldCreateHttp() {
    ...
    if (
      Bing.checkedForPluginInstall &&
      Bing.checkedForPluginInstall() !== true
    ) {
      return false;
    }
    return true;
  ...
  function createSpeech() {
    ...
    if (useHttp()) {
      ...
      if (Platform.supportsPPAPI()) {
        Bing._window.chrome.runtime.sendMessage(
          NaclClient.kKeyId,
          "__hello",
          null,
          function (response) {
  ...
  var WebAudioSource = (function () {
    ...
    WebAudioSource.prototype.removeEventListener = function (
      type,
      listener,
      useCapture
    ) {};
    WebAudioSource.prototype.addEventListener = function (
      type,
      listener,
      useCapture
    ) {};
  ...
  var ArrayBufferSource = (function () {
    ...
    ArrayBufferSource.prototype.removeEventListener = function (
      type,
      listener,
      useCapture
    ) {};
    ArrayBufferSource.prototype.addEventListener = function (
      type,
      listener,
      useCapture
    ) {};
    ...
    ArrayBufferSource.prototype.connect = function (
      destination,
      output,
      input
    ) {
  ...
  function SpeechMain() {
    ...
    var acWindow = window;
    mediaNav.getUserMedia =
      mediaNav.getUserMedia ||
      mediaNav.mozGetUserMedia ||
      mediaNav.webkitGetUserMedia ||
      mediaNav.msGetUserMedia ||
      CreateActiveXObject("Bing.GetUserMedia");
    acWindow.AudioContext =
      acWindow.AudioContext ||
      acWindow.webkitAudioContext ||
      CreateActiveXObject("Bing.AudioContext");
    Bing._window.SpeechSynthesisUtterance =
      Bing._window.SpeechSynthesisUtterance || msSpeechSynthesisUtterance;
