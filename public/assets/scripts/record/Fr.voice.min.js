...
!(function (t) {
  (t.Fr = t.Fr || {}),
    (Fr.voice = {
      ...
      record: function (t, e) {
        (e = e || function () {}),
          this.init_called === !1 && (this.init(), (this.init_called = !0)),
          ($that = this),
          navigator.getUserMedia(
            { audio: !0 },
            function (r) {
              var o = $that.context.createMediaStreamSource(r);
              t === !0 && o.connect($that.context.destination),
                ($that.recorder = new Recorder(o, {
      ...
      stop: function () {
        return this.recorder.stop(), this;
      },
      export: function (e, r) {
        "mp3" == r
          ? this.recorder.exportMP3(e)
          : this.recorder.exportWAV(function (o) {
              if ("" == r || "blob" == r) e(o);
              else if ("base64" == r) {
                var i = new t.FileReader();
                i.readAsDataURL(o),
                  (i.onloadend = function () {
                    (base64data = i.result), e(base64data);
                  });
              } else if ("URL" == r) {
