...
import { SignIn as SignIn } from "./SignIn";
import { SingUp as SignUp } from "./SignUp";
...
export const SignModal: FC<Props> = ({ onClick }) => {
    ...
    <div className={styles.wrapper}>
      <Foco component='div' onClickOutside={onClick} className={styles.modal} >
        <div className={styles.modalHead}>
          <div className={classnames(styles.switch, isSignInTab && styles.active)} onClick={() => setSignInTab(true)}>Sign In</div>
          <div className={classnames(styles.switch, !isSignInTab && styles.active)} onClick={() => setSignInTab(false)}>Sign Up</div>
